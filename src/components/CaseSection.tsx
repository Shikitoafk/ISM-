          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            {regulationsSection.downloads.map((d, i) => (
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg border border-slate-200 bg-slate-50 hover:bg-slate-100 text-slate-900 text-xs font-bold transition-colors"
              >
