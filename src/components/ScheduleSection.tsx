            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-300 text-[11px] font-bold uppercase text-slate-600 tracking-wider">
                  <th className="py-3 px-4 sm:px-6 w-36">{scheduleSectionUI.colTime}</th>
                  <th className="py-3 px-4 sm:px-6">{scheduleSectionUI.colEvent}</th>
                  <th className="py-3 px-4 sm:px-6 w-64">{scheduleSectionUI.colVenue}</th>
                </tr>
              </thead>
