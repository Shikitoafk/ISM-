            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50 border-b border-slate-300 text-[11px] font-bold uppercase text-slate-600 tracking-wider">
                  <th className="py-3 px-4 sm:px-6 w-52">{awardsSectionUI.colTier}</th>
                  <th className="py-3 px-4 sm:px-6 w-36">{awardsSectionUI.colTeams}</th>
                  <th className="py-3 px-4 sm:px-6">{awardsSectionUI.colDiploma}</th>
                  <th className="py-3 px-4 sm:px-6 w-56">{awardsSectionUI.colWinner}</th>
                </tr>
              </thead>
                ...
                {awardsTiers.map((item, idx) => (
                  <tr key={idx} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="py-3.5 px-4 sm:px-6 italic text-slate-400 font-normal">
                      {item.winnerTeamPlaceholder || awardsSectionUI.tbd}
                    </td>
                  </tr>
                ))}
              </tbody>
