  ...
  RU: {
    ...
    aboutCards: [
      ...
      },
      {
        ...
        subtitle: "4 обязательных + 1 дополнительный + руководитель",
        description: "4 основных участника-школьника (обязательно), 1 дополнительный 5-й участник и 1 руководитель команды (учитель/наставник)."
      }
    ],
    evaluationCriteria: {
    ...
    registrationFormUI: {
      ...
      subtitle: "Форму заполняет капитан команды. Состав: 4 основных участника (капитан + 3) + 1 дополнительный 5-й + 1 руководитель команды.",
      ...
      memberOptionalLabel: "(по желанию)",
      ...
      memberRoles: {
        ...
        optional5: "Дополнительный участник №5",
      },
    }
  },
